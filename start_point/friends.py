...
# def likes_too_eat(person, food):
#     if person['favourites']['snacks'] == 'bread':
#         return True
#     else:
#         return False
# print(likes_too_eat(person2, 'bread'))

# def likes_too_eat(person, food):
#     if person['favourites']['snacks'] == 'spinach':
#         return True
#     else:
#         return False
# print(likes_too_eat(person3, 'spinach'))
...
#     return person.append("Scrappy-Doo")

# add_friend(person2['friends'], 'Scrappy-Doo')
# print(person2)
...
def find_no_friends(people):
    ...
    for person in people:
        if len(person['friends']) == 0:
            lonely_person.append(person['name'])
    return lonely_person
...
def unique_favourite_tv_shows(people):
    unique_tv_show = []
    for person in people:
        if person['favourites']['tv_show'] not in unique_tv_show:
            unique_tv_show.append(person['favourites']['tv_show'])
    return unique_tv_show
